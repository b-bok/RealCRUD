...
public class PageInfo {
	...
	private int maxPage;			// 전체 페이지들 중 가장 마지막 페이지 수
	private int startPage;			// 현재 사용자가 요청한 페이지에 하단에 보여질 페이징 바의 시작수
	private int endPage;			// 현재 사용자가 요청한 페이지에 하단에 보여질 페이징 바의 끝 수
